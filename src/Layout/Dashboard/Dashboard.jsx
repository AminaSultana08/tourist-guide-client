...
const Dashboard = () => {
  ...
  return (
    <div className="flex">
      {/* dashboard side bar */}
      <Helmet>
        <title>Paladium Awatis | Dashboard</title>
      </Helmet>
        ...
        <div className="flex items-center justify-center mt-10 ">
          <ul className="menu text-lg text-red-500 font-bold  flex flex-col gap-10 ">
              ...
              <>
                <li className="w-full">
                  <NavLink
                    ...
                    className="flex items-center gap-1 hover:bg-red-200 p-3 rounded-lg bg-red-100 "
                  >
                    <BsFillPersonFill className="text-red-500 " /> My Profile
                  </NavLink>{" "}
                </li>
                <li className="w-full">
                  <NavLink
                    ...
                    className="flex items-center gap-1 hover:bg-red-200 p-3 rounded-lg bg-red-100 "
                  >
                    <MdPostAdd className="text-red-500 " />
                    Add Package
                  </NavLink>{" "}
                </li>
                <li className="w-full">
              ...
              <>
                ...
                <li className="w-full">
                  <NavLink
                    ...
                    className="flex items-center gap-1 hover:bg-red-200 p-3 rounded-lg bg-red-100 "
                  >
                    <MdOutlineAssignmentTurnedIn className="text-red-500 " />
                    My Assigned Tours
                  </NavLink>{" "}
                </li>
              </>
              ...
              <>
                ...
                <li className="w-full">
                  <NavLink
                    ...
                    className="flex items-center gap-1 hover:bg-red-200 p-3 rounded-lg bg-red-100 "
                  >
                    <FaBook className="text-red-500 " /> My Bookings
                  </NavLink>{" "}
                </li>
                ...
                <li className="w-full">
                  <NavLink
                    ...
                    className="flex items-center gap-1 hover:bg-red-200 p-3 rounded-lg bg-red-100 "
                  >
                    <BsClipboard2HeartFill className="text-red-500 " /> My Wish
            ...
            <div className="flex items-center justify-center">
              <hr
                className="my-2 w-1/2 text-center pb-5 border-red-300"
                role="menuitem"
              />
            ...
            <li className="w-full">
              <NavLink
                ...
                className="flex items-center gap-1 hover:bg-red-200 p-3 rounded-lg bg-red-100 "
              >
                <FaHome className="text-red-500" /> My Home
              </NavLink>{" "}
            </li>
          </ul>
        </div>
