    ...
    return (
        <div className="flex">
            ...
            <div className="w-64 min-h-screen bg-zinc-700">
                ...
                <li className="w-full"><NavLink to='/dashboard/myWishList' className="flex items-center gap-1 hover:bg-red-200 p-3 rounded-lg bg-red-100 "><BsClipboard2HeartFill className="text-red-500 "  /> My Wish List</NavLink> </li>
